// This file is now obsolete as PayPal interaction is handled
// directly via REST API calls in functions/src/index.ts
// and the @paypal/checkout-server-sdk is removed.
...
//   const errorMessage =
// `PayPal config missing. Set via Firebase config or .env.
